...
const resources = {
  uz: {
    translation: {
      ...
      professionalLevel: "Professional bilim darajangizni sinab ko'ring",
      quickExam: "Tezkor Imtihon",
      fullExam: "To'liq Imtihon",
      quickDescription: "Tez va samarali bilimlaringizni sinab ko'ring",
      fullDescription: "Chuqur va keng qamrovli bilim darajangizni aniqlang",
      questions: "ta savol",
      minutes: "daqiqa vaqt",
      allTopics: "Barcha mavzulardan",
      quickResult: "Tezkor natija",
      comprehensiveTest: "Keng qamrovli",
      detailedAnalysisText: "Batafsil tahlil",
      recommended: "Tavsiya etiladi",
      selectLanguage: "Imtihon tilini tanlang",
      examRules: "Imtihon qoidalari",
      timeStartsNow: "Imtihon boshlanishi bilan vaqt hisoblanadi",
      oneAnswerOnly: "Har bir savolga faqat bir marta javob berish mumkin",
      canSkip: "Savollarni o'tkazib yuborishingiz mumkin",
      autoFinish: "Vaqt tugashi bilan imtihon avtomatik yakunlanadi",
      immediateResults: "Natijalar darhol ko'rsatiladi",
      mistakesSaved: "Xatolar tahlili uchun saqlanadi",
      startExam: "Boshlash",
      preparing: "Tayyorlanmoqda...",
      maxScore: "max ball",
      totalScore: "Jami ball",

      // ExamTest sahifasi uchun
      leaveExam: "Imtihonni tark etmoqchimisiz?",
      timeUp: "Vaqt tugadi! Imtihon avtomatik yakunlanmoqda...",
      examCompleted: "Imtihon yakunlandi!",
      result: "Natija",
      percentage: "foiz",
      questionNavigation: "Savollar navigatsiyasi",
      ...
      answeredQuestions: "Javob berilgan",
      remaining: "Qolgan",
      completeExam: "Imtihonni yakunlash",
      answerAll: "Testni tugatish uchun barcha savollarga javob bering",
      nextQuestion: "Keyingi savol",
      previousQuestion: "Oldingi savol",
      finishExam: "Tugatish",
      mustAnswer: "Javob bering",

      // AdminDashboard sahifasi uchun
      ...
      planManagement: "Plan boshqaruvi",

      // StudentDetails sahifasi uchun
      studentDetails: "Talaba tafsilotlari",
      basicInfo: "Asosiy ma'lumotlar",
      contactInfo: "Aloqa ma'lumotlari",
      planInfo: "Plan ma'lumotlari",
      testResults: "Test natijalari",
      successRate: "Muvaffaqiyat darajasi",
      overallResult: "Umumiy natija",
      testDistribution: "Test natijalari taqsimoti",
      ...
      noPayments: "Hech qanday to'lov topilmadi",
      mistakesInfo: "Xatolar ma'lumotlari",
      totalMistakes: "Jami xatolar",
      averageMistakes: "O'rtacha xato (test uchun)",
      recentMistakes: "Oxirgi xatolar",
      noMistakes: "Hech qanday xato topilmadi",
      questionId: "Savol ID",

      // PlanManagement sahifasi uchun
      planPricing: "PRO Plan Narxlarini Boshqarish",
      proPlanSettings: "PRO Plan Sozlamalari",
      changePrice: "Bu yerda PRO plan narxlarini va muddatini o'zgartiring",
      currentPrice: "Joriy narx (so'm)",
      oldPrice: "Eski narx (chegirma ko'rsatish uchun, optional)",
      planDuration: "Plan muddati (kunlarda)",
      discountEndDate: "Chegirma tugash sanasi (optional)",
      priceExample: "Masalan: 19999",
      oldPriceExample: "Masalan: 40000",
      durationExample: "Masalan: 30",
      daysEqual: "kun =",
      months: "oy",
      days: "kun",
      ...
      changesApplyAll: "O'zgarishlar barcha foydalanuvchilar uchun amal qiladi",
      saving: "Saqlanmoqda...",
      save: "Saqlash",
      ...
      noChanges: "Hali o'zgarishlar yo'q",
      updatedBy: "Yangilagan",

      // Plans sahifasi qo'shimcha kalitlar
      refreshPrices: "Narxlarni yangilash",
      pricesUpdated: "Narxlar yangilandi",
      clickToPay: "Click orqali to'lash",
      qrToPay: "QR kod orqali to'lash",
      originalPrice: "Asl narxi",
      discountUntil: "gacha",
      planDurationDays: "Muddat: {{count}} kun",

      // Test sahifasi qo'shimcha kalitlar
      exitTest: "Testni tark etmoqchimisiz?",
      completed: "Tugallangan",
      skipped: "O'tkazilgan",
      testTitle: "Test {{id}}",
      answerLengthLong: "Javob uzun",

      // Profile sahifasi qo'shimcha kalitlar
      subscriptionInfo: "Obuna ma'lumotlari",
      planExpiry: "Plan tugash sanasi",
      dailyLimit: "Kunlik limit",
      upgradeAccount: "Hisobni yangilash",
      paymentMethods: "To'lov usullari",

      // AdminProtectedRoute uchun
      adminPanelLoading: "Admin panel yuklanmoqda...",

      // Umumiy qo'shimcha kalitlar
  ...
  ru: {
    translation: {
      ...
      professionalLevel: "Проверьте свой профессиональный уровень знаний",
      quickExam: "Быстрый экзамен",
      fullExam: "Полный экзамен",
      quickDescription: "Быстро и эффективно проверьте свои знания",
      fullDescription: "Глубоко и всесторонне определите свой уровень знаний",
      questions: "вопросов",
      minutes: "минут времени",
      allTopics: "Из всех тем",
      quickResult: "Быстрый результат",
      comprehensiveTest: "Всеобъемлющий",
      detailedAnalysisText: "Подробный анализ",
      recommended: "Рекомендуется",
      selectLanguage: "Выберите язык экзамена",
      examRules: "Правила экзамена",
      timeStartsNow: "Время начинает считаться с начала экзамена",
      oneAnswerOnly: "На каждый вопрос можно ответить только один раз",
      canSkip: "Вы можете пропускать вопросы",
      autoFinish: "По истечении времени экзамен автоматически завершается",
      immediateResults: "Результаты показываются немедленно",
      mistakesSaved: "Ошибки сохраняются для анализа",
      startExam: "Начать",
      ...
      // ExamTest sahifasi uchun
      leaveExam: "Вы хотите покинуть экзамен?",
      timeUp: "Время истекло! Экзамен автоматически завершается...",
      examCompleted: "Экзамен завершён!",
      result: "Результат",
      ...
      answeredQuestions: "Отвеченных",
      remaining: "Осталось",
      completeExam: "Завершить экзамен",
      answerAll: "Чтобы завершить тест, ответьте на все вопросы",
      nextQuestion: "Следующий вопрос",
      previousQuestion: "Предыдущий вопрос",
      finishExam: "Завершить",
      mustAnswer: "Дайте ответ",
      ...
      testDistribution: "Распределение результатов тестов",
      ...
      mistakesInfo: "Информация об ошибках",
      totalMistakes: "Всего ошибок",
      averageMistakes: "Средние ошибки (за тест)",
      recentMistakes: "Последние ошибки",
      noMistakes: "Ошибки не найдены",
      questionId: "ID вопроса",

      // PlanManagement sahifasi uchun
      planPricing: "Управление ценами PRO плана",
      proPlanSettings: "Настройки PRO плана",
      changePrice: "Здесь измените цены и сроки PRO плана",
      currentPrice: "Текущая цена (сум)",
      oldPrice: "Старая цена (для показа скидки, опционально)",
      planDuration: "Срок плана (в днях)",
      discountEndDate: "Дата окончания скидки (опционально)",
      priceExample: "Например: 19999",
      oldPriceExample: "Например: 40000",
      durationExample: "Например: 30",
      daysEqual: "дней =",
      months: "месяцев",
      days: "дней",
      ...
      savings: "экономия",
      appearance: "Вид",
      changesApplyAll: "Изменения применяются ко всем пользователям",
      saving: "Сохранение...",
      save: "Сохранить",
      ...
      clickToPay: "Оплатить через Click",
      qrToPay: "Оплатить через QR код",
      originalPrice: "Первоначальная цена",
      discountUntil: "до",
      planDurationDays: "Срок: {{count}} дней",

      // Test sahifasi qo'shimcha kalitlar
      exitTest: "Вы хотите покинуть тест?",
      completed: "Завершено",
      skipped: "Пропущено",
      testTitle: "Тест {{id}}",
      answerLengthLong: "Длинный ответ",

      // Profile sahifasi qo'shimcha kalitlar
      subscriptionInfo: "Информация о подписке",
      planExpiry: "Дата окончания плана",
      dailyLimit: "Дневной лимит",
      upgradeAccount: "Обновить аккаунт",
      paymentMethods: "Способы оплаты",

      // AdminProtectedRoute uchun
      adminPanelLoading: "Загрузка админ панели...",
      ...
      closeModal: "Закрыть модал",
      openModal: "Открыть модал",
  ...
  uz_kiril: {
    translation: {
      ...
      professionalLevel: "Профессионал билим даражаңизни синаб кўринг",
      quickExam: "Тезкор Имтиҳон",
      fullExam: "Тўлиқ Имтиҳон",
      quickDescription: "Тез ва самарали билимларингизни синаб кўринг",
      fullDescription: "Чуқур ва кенг қамровли билим даражаңизни аниқланг",
      questions: "та савол",
      minutes: "дақиқа вақт",
      allTopics: "Барча мавзулардан",
      quickResult: "Тезкор натижа",
      comprehensiveTest: "Кенг қамровли",
      detailedAnalysisText: "Батафсил таҳлил",
      recommended: "Тавсия этилади",
      selectLanguage: "Имтиҳон тилини танланг",
      examRules: "Имтиҳон қоидалари",
      timeStartsNow: "Имтиҳон бошланиши билан вақт ҳисобланади",
      oneAnswerOnly: "Ҳар бир саволга фақат бир марта жавоб бериш мумкин",
      canSkip: "Саволларни ўтказиб юборишингиз мумкин",
      autoFinish: "Вақт тугаши билан имтиҳон автоматик якунланади",
      immediateResults: "Натижалар дарҳол кўрсатилади",
      mistakesSaved: "Хатолар таҳлили учун сақланади",
      startExam: "Бошлаш",
  ...
  kaa: {
    translation: {
      ...
      professionalLevel: "Professional bilim darajańızdı sinap kóriń",
      quickExam: "Tez Imtihan",
      fullExam: "Tolıq Imtihan",
      quickDescription: "Tez hám samaralı bilimlerińizdi sinap kóriń",
      fullDescription: "Tereń hám keń qamrawlı bilim darajańızdı anıqlań",
      questions: "ta soraw",
      minutes: "daqıyqa waqt",
      allTopics: "Barlıq mawzulardan",
      quickResult: "Tez natija",
      comprehensiveTest: "Keń qamrawlı",
      detailedAnalysisText: "Batafsil tahlil",
      recommended: "Usınıladı",
      selectLanguage: "Imtihan tilini tanlań",
      examRules: "Imtihan qáġıdaları",
      timeStartsNow: "Imtihan baslanıwı menen waqt esaplandı",
      oneAnswerOnly: "Hár bir sorawǵa faqat bir márte juwap beriw múmkin",
      canSkip: "Sorawlardı ótkerip jiberiw múmkin",
      autoFinish: "Waqt tugawı menen imtihan awtomatik túgetiledi",
      immediateResults: "Natijalar darhal kórsetiledi",
      mistakesSaved: "Qátelikler tahlili ushın saqlanadı",
      startExam: "Baslaw",
      preparing: "Tayarlanıwda...",
      maxScore: "maks bal",
      totalScore: "Jami bal",
